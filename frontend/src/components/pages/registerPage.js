...
import { FaEye, FaEyeSlash, FaFilm, FaUser, FaLock, FaEnvelope, FaUserPlus } from "react-icons/fa";
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="cine-card p-8 animate-slide-up">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Email Field */}
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-cine-text mb-2">
                Email Address
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FaEnvelope className="h-5 w-5 text-cine-text-secondary" />
                </div>
                <input
                  id="email"
                  name="email"
